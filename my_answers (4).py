...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        final_outputs = final_inputs # signals from final output layer (activation function y = x)
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # Weight step (input to hidden) hidden_error_term is a 1-D array.
        # 
    ...
    def update_weights(self, delta_weights_i_h, delta_weights_h_o, n_records):
        ...
        '''
        # divide the accumulated weights by n_records as we are performing batch gradient descent, this will enable better hyper            parameter tuning.

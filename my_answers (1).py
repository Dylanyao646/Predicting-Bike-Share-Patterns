...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        hidden_outputs = self.activation_function(X.dot(self.weights_input_to_hidden)) # signals from hidden layer

        # TODO: Output layer - Replace these values with your calculations.
        final_inputs =  hidden_outputs # signals into final output layer
        final_outputs = hidden_outputs.dot(self.weights_hidden_to_output) # signals from final output layer
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # Weight step (input to hidden) hidden_error_term is a scalar, so a simple * multiplication would work.
        # 
        delta_weights_i_h += X[:,None] * hidden_error_term
        # Weight step (hidden to output) output_error_term is a scalar, so a simple * multiplication would work.
        ...
        #print('hidden_outputs[:,None]', hidden_outputs[:,None].shape)
    ...
    def run(self, features):
        ...
        for i in range(len(features)):
            hidden_inputs = features[i] # signals into hidden layer
